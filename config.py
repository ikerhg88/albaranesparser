...
DETECTION_CONFIG = {
    ...
    "brand_aliases": {
        ...
        "AXOR": ["AXOR", "AXOR RENTALS", "AXOR RENTALS S.L.U.", "B01213032"],
        "SALTOKI": ["SALTOKI", "SAL TOKI", "SALTOKI GIPUZKOA"],
        "SALVI": ["SALVI", "SALVILIGHTING", "SALVI S.L."],
        "TC MEDIDA": ["TC MEDIDA", "TC MEDIDA Y CONTROL DE TEMPERATURA", "TC-SA.ES", "A83703041"],
        "MONTTE": ["MONTTE", "MONTTE VERDE"],
        "GABYL": ["GABYL"],
    ...
    "header_regex": {
        ...
        "AXOR": [
            r"ALBAR[ÁA]N\s+DE\s+DEVOLUCI[ÓO]N",
            r"ART[ÍI]CULO.*CONCEPTO.*CAN.*PRECIO.*IMPORTE",
        ],
        "SIGNIFY": [
            r"SIGNIFY",
            r"PALLET\s+CONTENTS",
        ...
        "TC MEDIDA": [
            r"TC\s+Medida\s+y\s+Control",
            r"Albar[aá]n:\s*AL\s+\d+",
        ],
        "MONTTE": [
            r"MONTTE",
            r"C[oó]d\.\s*UM\s+Descripci[oó]n",
        ],
    },
}
